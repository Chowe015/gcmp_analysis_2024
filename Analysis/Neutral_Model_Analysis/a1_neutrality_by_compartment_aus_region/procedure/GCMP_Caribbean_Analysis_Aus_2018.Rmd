...
write.table(microbial_faith, file ="aus_compartment_microbial_faith_pd_table.csv", sep = ",",col.names = TRUE)

write.csv(coral_faithpd_reorded, file ="aus_compartment_Host_faith_pd_table.csv" ,row.names = TRUE)
