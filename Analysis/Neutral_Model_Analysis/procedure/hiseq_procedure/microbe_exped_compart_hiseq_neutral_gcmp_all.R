...
sink_name = paste0("Step3_",biosample,"_expedition_neutral_results_log.txt")
...
sncm.fit <- function(spp, pool=NULL, stats=TRUE, taxon=NULL){
  ...
  bino.mle <- mle(bino.LL, start=list(mu=0, sigma=0.1), nobs=length(p),method="Nelder-Mead")
...
expedition <- c("E1","E3","E4","E5","E7","E9","E10","E11")
...
neutral_file_name <- paste0("hiseq_",biosample,"_",i,"_neutral_model_Plot.pdf")
...
exp_table_name <- paste0("hiseq_",biosample,"_",i,"_neutral_model_statistical_results.tsv")
