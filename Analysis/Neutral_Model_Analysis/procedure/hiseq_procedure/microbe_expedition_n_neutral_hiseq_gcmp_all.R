...
subject = subset_samples(phylo, outgroup=="n"  & sample_type_EMP=="coral")
subject
...
neutral_file_name <- paste0("Hiseq_",i,"_neutral_model_Plot.pdf")
...
exp_table_name <- paste0("Hiseq_",i,"_neutral_model_statistical_results.txt")
