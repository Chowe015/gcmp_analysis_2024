...
psuedo_spp_name <- paste0("Miseq_",spp_id,"_subset_",pool_id,"_abundance_neutral_table.tsv")
  (write.table(nonneutral_tax, file =psuedo_spp_name,sep="\t", row.names = FALSE))

# Print output files
spp_sample_name <- paste0("Miseq_",spp_id,"_",pool_id,"_neutral_model_statistical_results.txt")
...
## Results table
psuedo_spp_name2 <- paste0("Miseq_",i,"_subset_",g,"_abundance_neutral_table.tsv")
write.table(nonneutral_tax2, file =psuedo_spp_name2,sep="\t", row.names = FALSE,col.names = TRUE)
# Print output files
psuedo_pool_name <- paste0("Miseq_",g,"_subset_",i,"_neutral_model_statistical_results.txt")
...
ncm_name <- paste0("Miseq_",g,"_",i,"_neutral_model_Plot.pdf")
