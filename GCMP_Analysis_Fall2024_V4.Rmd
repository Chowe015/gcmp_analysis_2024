...
glom_coral <- tax_glom(coral.rarefied, taxrank = 'Family', NArm = TRUE) ## 448 Samples 
...
## Assign Taxonomy to table of significant microbes
#env_taxa = cbind(as(mod1_w_seawater, "data.frame"), as(tax_table(glom_cglom_watol5)[rownames(mod1_w_seawater), ], "matrix"))
...
lb2 <- mod_w_coral$m
lb3 <- expression(paste("Corals from E2 E5 E11 E12 E15 Coral Samples"))
...
rt.pcoa = ordinate(coral.rarefied, method="PCoA", distance=wuni_coral)
...
bray_carib_pairwise <-pairwise.perm.manova(bray_coral, coral_df$expedition_number,nperm=1000,p.method = "BH") 
uni_carib_pairwise <-pairwise.perm.manova(uni_coral,coral_df$expedition_number,nperm=1000,p.method = "BH")
wuni_carib_pairwise <-pairwise.perm.manova(wuni_coral,coral_df$expedition_number,nperm=1000,p.method = "BH")
