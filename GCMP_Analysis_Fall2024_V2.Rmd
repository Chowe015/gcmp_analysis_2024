...
asv <- qza_to_phyloseq(features = "gcmp_qiime_input/carib_silva_merged_table.qza")

#### Import Metadata read.table
metadata <- read.table(file = "gcmp_qiime_input/carib_merged_mapping.csv",header=T,comment.char="", row.names=1, sep=",")
