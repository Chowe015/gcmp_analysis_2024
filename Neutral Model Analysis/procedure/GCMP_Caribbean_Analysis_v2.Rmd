...
metadata <- read.table(file = "./Atlantic_Pacific_expeditions/input/carib_merged_mapping.csv",header=T,comment.char="", row.names=1, sep=",")
...
write.csv(glom_otu_table, file =taxonomy_file_name ,row.names = FALSE)
