...
write.table(microbial_faith, file ="./carib_microbial_faith_pd_table.csv", sep = ",",col.names = TRUE)

write.csv(coral_faithpd_reorded, file ="./carib_coralHost_faith_pd_table.csv" ,row.names = TRUE)
