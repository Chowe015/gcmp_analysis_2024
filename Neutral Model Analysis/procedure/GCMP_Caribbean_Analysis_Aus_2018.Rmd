...
write.table(microbial_faith, file ="aus_microbial_faith_pd_table.csv", sep = ",",row.names =TRUE, col.names = TRUE)

write.csv(coral_faithpd_reorded, file ="aus_coralHost_faith_pd_table.csv" ,row.names = TRUE)
